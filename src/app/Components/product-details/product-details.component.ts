...
export class ProductDetailsComponent implements OnInit {
  ...
  productIDs:number[]=[];
  constructor(public productService: ProductsService,public activatedRoute:ActivatedRoute,public location:Location,private router:Router) {}
  ngOnInit(): void {
  ...
  prevPrd(){
    let currentIndex=this.productIDs.findIndex((ele)=>ele==this.currentProductId);
